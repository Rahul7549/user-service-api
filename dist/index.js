  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", res.send('method called'));
        case 1:
        case "end":
...
app.get('/zoho-token', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var zohoTokenUrl;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          zohoTokenUrl = "https://accounts.zoho.in/oauth/v2/token?refresh_token=".concat(process.env.REFRESH_TOKEN, "&client_id=").concat(process.env.CLIENT_ID, "&client_secret=").concat(process.env.CLIENT_SECRET, "&grant_type=refresh_token");
